// ! 객체의 속성 존재 여부 확인
// : 객체에 없는 속성에 접근 - undefind 자료형
// : 조건문으로 undefind인지 아닌지 확인
...
// name속성을 aaa라는 이름, price속성을 bb라는 이름으로 꺼내옴
...
물건_1125.push('치즈');
console.log(물건_1123); // 치즈 추가 X > 1125와 1123이 완전히 독립

// 전개 연산자를 배용한 배열 요소 추가
// [...배열, 자료, 자료, 자료]

const 추가구매 = ['감자, 오렌지주스'];
const 물건_1126 = ['양파', ...물건_1125, ...추가구매];
console.log(물건_1126); // ['양파', '우유', '식빵', '고구마', '토마토', '치즈', '감자, 오렌지주스']
