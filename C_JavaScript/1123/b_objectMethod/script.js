...
// ? JSON 구조
// : JSON내부에넌 JS에서 사용할 수 있는 기본 데이터 타입인 문자열, 숫자, 배열, 불리언, 그 밖의 다른 객체 또한 포함 가능
// : JS의 배열과 객체를 활용하여 어떠한 자료의 형태를 표현하는 방식
...
// : 객체에서 어떤 속성만 선택해서 추출하곳 ㅣㅍ을 때 사용
...
// ! Date 객체
// : 난짜와 시간을 처리하는 메소드를 제공
let now = new Date();
console.log(now);
console.log(now.getDate()); // 23 (일자)
console.log(now.getDay()); // 4 (목요일 | 1 = 월요일, 2 = 화요일 ...)